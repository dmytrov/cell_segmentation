...
If (WinType("IPLPosPanel"))
	...
	NewPanel /K=2 /N=IPLPosPanel /W = (left-halfwidth,top-halfheight,left+halfwidth, top+halfheight) as "IPL Measurement Panel"
