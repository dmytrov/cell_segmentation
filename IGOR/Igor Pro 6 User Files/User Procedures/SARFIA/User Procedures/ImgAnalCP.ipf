...
string Information = IgorInfo(0), infolist, infolist2
...
variable left=screenright - 330, top = 0
...
If (WinType("IAControlPanel"))
	...
	groupbox MainButtons pos={5,5}, size={320,70}//, title = "Main Controls"
	groupbox WaveControls pos={5, 80}, size={320,120}
	groupbox QAControls pos={5, 210}, size={320, 260}//, title = "Quick Analysis"
...
//	Button Display2D, pos = {20, row2 + 80},size={60,20}, proc=ButtonPress, title="Display", disable = 2
	...
	PopUpMenu Action2D, pos = {20, row2 + 80},proc = PopProc,mode=0,title="Action"  , value="Display;PopWaveBrowse;Filter;PopX2Traces;Threshold;Invert;Rotate;Rename;Save;Kill;Recognize Cells",disable=2
...
strswitch(ctrlname)
	...
	strswitch(popstr) 
		//--------------------------------------------------------------------------------------------
		//case "Recognize cells": 
		//	strswitch(g_NameOf3DWave)
		//		case "none":		
		//			Print "Please select an appropriate wave"
		//			break
		//		default:
		//			RecognizeCellsUI($g_NameOf3DWave,targetname)
		//			
		//	endswitch //g_NameOf2DWave
		//	break
		//--------------------------------------------------------------------------------------------
		...
		StrSwitch(PopStr)
			...
			strswitch(g_NameOf2DWave)
				case "none":		
					...
					break
				default:
					targetname = g_NameOf2DWave+"_SARFIA_ROI"
					RecognizeCellsUI($g_NameOf2DWave, targetname, "")
