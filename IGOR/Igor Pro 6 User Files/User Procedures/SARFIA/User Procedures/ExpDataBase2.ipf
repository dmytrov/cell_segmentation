...
Function/wave TraceFromDB(DataBase, index,[ResultName])		//Makes a traces for displaying/analysing etc. from the database
	wave Database
	Variable Index
	String ResultName
	...
	Variable nPoints, XDelta,XOffSet, UnitPos
	String XUnit
...
Function/wave PopFromDB(DataBase,[ResultName])		//Makes a traces for displaying/analysing etc. from the database
	wave Database
	String ResultName
	...
	Make/o/free/n=(nTraces) nPoints, XDelta,XOffSet, UnitPos
	String XUnit
	...
	make /d/n=(nPoints,nTraces)/o $ResultName
	wave trace=$ResultName
