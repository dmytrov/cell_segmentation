classdef TMakeROIFrom3DModelsAndFunctionalScan < Core.TProcessor
    ...
    methods (Access = public)
        function this = TMakeROIFrom3DModelsAndFunctionalScan(name, pipeline)
        ...
        function Run(this)
            ...
            ROI = Segment3D.MakeROIFrom3DModelsAndFunctionalScan(this.Settings, models, stack3D, stackFunctional);
