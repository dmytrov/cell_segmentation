...
public class SceneLayer3D extends SceneLayer {
	...
	public void setupMaterials(GL2 gl)
	{
        float[] rgb = {0.3f, 0.5f, 0.5f};
        float[] rgbSpec = {1.0f, 1.0f, 1.0f};
        gl.glMaterialfv(GL.GL_FRONT, GL2.GL_AMBIENT, rgb, 0);
        gl.glMaterialfv(GL.GL_FRONT, GL2.GL_DIFFUSE, rgb, 0);
        gl.glMaterialfv(GL.GL_FRONT, GL2.GL_SPECULAR, rgbSpec, 0);
        gl.glMaterialf(GL.GL_FRONT, GL2.GL_SHININESS, 20.0f);
	}
